...
import nl.surfnet.onelogin.Util;
...
public class AuthRequest {
	...
	if (format == base64) {
	    // byte [] encoded =
	    // Base64.encodeBase64Chunked(Util.compress(baos.toByteArray()).getBytes());
	    ...
	    String result = new String(Base64.encodeBase64Chunked(bytesOut.toByteArray()));
